...
;
-- From the above code output the below are the null value observed are:
-- Country - 20 Nos
-- Worlwide_gross income - 3724 Nos
-- Languages - 194 Nos
-- production_company - 528 Nos
...
-- In Year 2018 highest no. of movies were released i.e, 2944
-- In Year 2019 highest no. of movies were released i.e, 2001
...
-- the highest number of movies released in the month of march ie 824
...
-- USA and India produced more than a thousand movies in total  which is 1059 in the year 2019.
...
-- Drama Genre has the highest number of the movies produced which is 4285 Nos
...
-- So as per the above code output there are 3289 movies that belong to genre
...
-- The average duration of action genre has the highest duration as 112.88
...
-- The rank of the ‘thriller’ genre of movies among all the genres in terms of number of movies produced is 3 and movie count of 1484.
...
-- Movies with the 7 median is the highest as per the output
...
-- James Mangold , Soubin Shahir and Anthony Russo are top three directors in the top three genres whose movies has an average rating > 8.
...
-- top two actor below with movie_count are as mentioned
-- Mammootty 8
-- Mohanlal	5
...
-- Yes Marvel Studios rule the world
...
--  Vijay Sethupathi, Fahadh Faasil and Yogi Babu are top 3 actors in respective order as per the output. 
...
-- Top two production houses that have produced the highest number of hits among multilingual movies are,
-- 1) Star Cinema
...
-- Top 3 actresses based on number of Super Hit movies are,
...
-- As per the code output, the list of the top 9 directors as mentioned below:
-- Andrew Jones
-- A.L. Vijay
-- Sion Sono
-- Chris Stokes
